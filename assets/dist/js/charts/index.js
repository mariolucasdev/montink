    ...
    //         },
    //     })).render();
    //     window.ApexCharts && (new ApexCharts(document.getElementById('chart-revenue-bg-3'), {
    //         chart: {
    //             type: "area",
    //             fontFamily: 'inherit',
    //             height: 40.0,
    ...
    //         },
    //     })).render();
    //     window.ApexCharts && (new ApexCharts(document.getElementById('chart-revenue-bg-4'), {
    //         chart: {
    //             type: "area",
    //             fontFamily: 'inherit',
    //             height: 40.0,
    ...
    // // @formatter:off
    // document.addEventListener("DOMContentLoaded", function() {
    //     window.ApexCharts && (new ApexCharts(document.getElementById('chart-development-activity-colabs'), {
    //         chart: {
    //             type: "area",
    //             fontFamily: 'inherit',
    //             height: 50,
